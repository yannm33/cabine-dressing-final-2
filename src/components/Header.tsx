...
const Header: React.FC<HeaderProps> = ({ isMockMode = false, isStartScreen = false }) => {
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            {isStartScreen ? (
                ...
                <h1 className="text-2xl font-serif tracking-widest text-gray-800 whitespace-nowrap">
                    {t('virtualTryOn')}
                </h1>
            )}
        </div>
